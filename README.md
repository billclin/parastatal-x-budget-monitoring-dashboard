...
[![Python validation checks](https://github.com/lilbclin/parastatal-x-budget-monitoring-dashboard/actions/workflows/python-validation.yml/badge.svg)](https://github.com/lilbclin/parastatal-x-budget-monitoring-dashboard/actions/workflows/python-validation.yml)
